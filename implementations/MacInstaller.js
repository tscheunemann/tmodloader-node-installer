class MacInstaller {
    ...
    install_tmod(cb) {
        ...
        config['os'] = 'Mac';
        config['defaultTerrariaInstall'] = `${homedir}/Library/Application Support/Steam`
        config['test'] = "this is a test";
        config['test1'] = "this is also a test";
        config['steam_vdf_registry'] = "Library/Application Support/Steam/steamapps/libraryfolders.vdf";
        config['terrariaExecutable'] = 'Terraria.exe';
        ...
        config['terrariaSteamDir'] = "Terraria.app/Contents/MacOS/";
